...
@section('content')
    ...
    <div class="content container-fluid mb-5">
        <a href="{{route('result.student.posttest.index')}}" class="btn btn-warning">Kembali <i class="tio-chevron-left"></i></a>

        <div class="row justify-content-sm-center text-center">
            <div class="col-sm-7 col-md-5">
                <img class="img-fluid mb-5" src="{{asset('assets/svg/illustrations/graphs.svg')}}" alt="Image Description"
                     style="max-width: 21rem;">
                <h1>{{$posttestUser->user->name}} - {{$posttestUser->user->kelas}}, Sudah selesai post test</h1>
                <p>Anda bisa melihat nilainya di bawah ini!</p>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-12">

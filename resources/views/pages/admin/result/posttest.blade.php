        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-sm-0">
                    <h1 class="page-header-title">Siswa yang sudah post test <span class="badge badge-soft-dark ml-2">{{count($data_post_test)}}</span>
                    </h1>
                </div>
            </div>
        </div>
        ...
        <div class="card mb-3 mb-lg-5">
                ...
                <div class="row justify-content-between align-items-center flex-grow-1">
                    <div class="col-12 col-md">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="card-header-title">Siswa yang sudah post test</h5>
            ...
            <div class="table-responsive datatable-custom">
                <table id="datatable"
                    ...
                    <tbody>
                    @foreach($data_post_test as $data)
                        <tr>
                            <td>{{$data->user->nis}}</td>
                            <td>
                            ...
                            <td>
                                <a class="btn btn-outline-info btn-sm" href="{{ route('result.student.posttest.detail',$data->id) }}">Lihat</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>

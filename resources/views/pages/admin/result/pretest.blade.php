        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-sm-0">
                    <h1 class="page-header-title">Siswa yang sudah pre test <span class="badge badge-soft-dark ml-2">{{count($data_pre_test)}}</span>
                    </h1>
                </div>
            </div>
        </div>
                ...
                <div class="row justify-content-between align-items-center flex-grow-1">
                    <div class="col-12 col-md">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="card-header-title">Siswa yang sudah pre test</h5>
                ...
                <table id="datatable"
                    ...
                    @foreach($data_pre_test as $data)
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-outline-info btn-sm" href="{{ route('result.student.pretest.detail',$data->id) }}">Lihat</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>

...
@section('content')
    ...
    <div class="content container-fluid">
        <div class="card mb-3 mb-lg-5">
            ...
            <form class="js-step-form" action="{{route('student.update', $student->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class="col-lg-12">
...
{{--                                       name="kelas" id="kelas" value="{{ old('kelas', $student->kelas) }}">--}}
                                <select id="kelas"
                                        ...
                                        autofocus>
                                    <option value="" @if($student->kelas == "")  selected @endif>Pilih Kelas</option>
                                    <option value="10" @if($student->kelas == "10")  selected @endif>Kelas 10</option>
                                    <option value="11" @if($student->kelas == "11")  selected @endif>Kelas 11</option>
                                    <option value="12" @if($student->kelas == "12")  selected @endif>Kelas 12</option>
                                </select>
                                @error('kelas')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>

            ...
            <div class="row align-items-center">
                <div class="col-sm mb-sm-0">
                    <h1 class="page-header-title">
                        ...
                        @endrole
                        <span class="badge badge-soft-dark ml-2">{{count($student)}}</span>
                    </h1>
                </div>
                ...
                <div class="row justify-content-between align-items-center flex-grow-1">
                    <div class="col-12 col-md">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="card-header-title">Siswa</h5>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="avatar avatar-circle mr-3">
                                    <img class="avatar-img" src="{{asset($data->foto)}}"/>
                                </div>
                            </td>
                            <td>{{$data->name}}</td>
                            <td>{{$data->status}}</td>
                            <td>
                                <form action="{{ route('student.destroy', $data->id) }}" method="POST">
                                    <a class="btn btn-outline-info btn-sm" href="{{ route('student.show',$data->id) }}">Show</a>
                                    <a class="btn btn-outline-primary btn-sm" href="{{ route('student.edit',$data->id) }}">Edit</a>
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit " class="btn btn-outline-danger btn-sm"><i
                                            class="tio-delete ml-1"></i> Delete
                                    </button>
                                    <a class="btn btn-outline-success btn-sm" href="{{ route('student.active',$data->id) }}">Ubah Status</a>
                                </form>
                            </td>
                        </tr>
                    @endforeach

...
@section('content')
    ...
    <div class="content container-fluid">
        <div class="card mb-3 mb-lg-5">
            ...
            <form class="js-step-form" action="{{route('posttest.update', $posttest->id)}}" method="post">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class="col-lg-12">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-12">
                                <textarea name="soal" class="ckeditor form-control @error('soal') is-invalid @enderror" id="soal">{{ old('soal', $posttest->soal) }}</textarea>
                                @error('soal')
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-9">
                                <select id="role"
                                        ...
                                        autofocus>
                                    <option value="emosi" {{ $posttest->aspek == "emosi" ? 'selected' : '' }}>Emosi</option>
                                    <option value="fisik" {{ $posttest->aspek == "fisik" ? 'selected' : '' }}>Fisik</option>
                                    <option value="perilaku" {{ $posttest->aspek == "perilaku" ? 'selected' : '' }}>Perilaku</option>
                                    <option value="psikologi" {{ $posttest->aspek == "psikolgi" ? 'selected' : '' }}>Psikologi</option>
                                </select>

...
@section('content')
    ...
    <div class="content container-fluid">
        <div class="card mb-3 mb-lg-5">
            ...
            <form class="js-step-form" action="{{route('forum.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="col-lg-12">
                        <!-- Form Group -->
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-12">
                                <textarea name="description" class="ckeditor form-control @error('description') is-invalid @enderror" id="description">{{ old('description') }}</textarea>
                                @error('description')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>

        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-sm-0">
                    <h1 class="page-header-title">Artikel<span class="badge badge-soft-dark ml-2">{{count($article)}}</span>
                    </h1>
                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="avatar avatar-circle mr-3">
                                    <img class="avatar-img" src="{{asset('uploads/articles/'.$data->image)}}"/>
                                </div>
                            </td>
                            <td>{{$data->title}}</td>
                            <td>Klik tombol show untuk melihat deskripsi</td>
                            <td>
                                <form action="{{ route('article.destroy', $data->slug) }}" method="POST">
                                    <a class="btn btn-outline-info btn-sm" href="{{ route('article.show',$data->slug) }}">Show</a>
                                    <a class="btn btn-outline-primary btn-sm" href="{{ route('article.edit',$data->slug) }}">Edit</a>
                                    @csrf
                                    @method('DELETE')

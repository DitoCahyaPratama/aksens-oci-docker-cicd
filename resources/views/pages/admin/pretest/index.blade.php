        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-sm-0">
                    <h1 class="page-header-title">Soal Pre Test<span class="badge badge-soft-dark ml-2">{{count($pretest)}}</span>
                    </h1>
                </div>

                <div class="col-sm-auto">
                    <a href="{{route('pretest.create')}}" class="btn btn-primary">
        ...
        <div class="card mb-3 mb-lg-5">
                ...
                <div class="row justify-content-between align-items-center flex-grow-1">
                    <div class="col-12 col-md">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="card-header-title">Soal Pre Test</h5>
            ...
            <div class="table-responsive datatable-custom">
                <table id="datatable"
                    ...
                    <tbody>
                    @foreach($pretest as $data)
                        <tr>
                            <td>{{$data->id}}</td>
                            <td>{!! $data->soal !!}</td>
                            <td>{{$data->aspek}}</td>
                            <td>
                                <form action="{{ route('pretest.destroy', $data->id) }}" method="POST">
                                    <a class="btn btn-outline-info btn-sm" href="{{ route('pretest.show',$data->id) }}">Show</a>
                                    <a class="btn btn-outline-primary btn-sm" href="{{ route('pretest.edit',$data->id) }}">Edit</a>
                                    @csrf
                                    @method('DELETE')

        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-sm-0">
                    <h1 class="page-header-title">Guru<span class="badge badge-soft-dark ml-2">{{count($teacher)}}</span>
                    </h1>
                </div>
            </div>
        </div>
                ...
                <div class="row justify-content-between align-items-center flex-grow-1">
                    <div class="col-12 col-md">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="card-header-title">Guru</h5>
                ...
                <table id="datatable"
                    ...
                    @foreach($teacher as $data)
                        <tr>
                            ...
                            <td>{{$data->status}}</td>
                            <td>
                                <a class="btn btn-outline-success btn-sm" href="{{ route('teacher.active',$data->id) }}">Ubah Status</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>

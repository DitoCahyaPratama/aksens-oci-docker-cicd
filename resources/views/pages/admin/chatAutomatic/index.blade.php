        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-sm-0">
                    <h1 class="page-header-title">List Chat Otomatis<span class="badge badge-soft-dark ml-2">{{count($chatautomatic)}}</span>
                    </h1>
                </div>

                <div class="col-sm-auto">
                    <a href="{{route('chatautomatic.create')}}" class="btn btn-primary">
                        Tambah Chat Otomatis
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="card mb-3 mb-lg-5">
                ...
                <div class="row justify-content-between align-items-center flex-grow-1">
                    <div class="col-12 col-md">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="card-header-title">Chat Otomatis</h5>
            ...
            <div class="table-responsive datatable-custom">
                <table id="datatable"
                    ...
                    <tbody>
                    @foreach($chatautomatic as $data)
                        <tr>
                            <td>{{$data->id}}</td>
                            <td>{!! $data->chat !!}</td>
                            <td>
                                <form action="{{ route('chatautomatic.destroy', $data->id) }}" method="POST">
                                    <a class="btn btn-outline-info btn-sm" href="{{ route('chatautomatic.show',$data->id) }}">Show</a>
                                    <a class="btn btn-outline-primary btn-sm" href="{{ route('chatautomatic.edit',$data->id) }}">Edit</a>
                                    @csrf
                                    @method('DELETE')

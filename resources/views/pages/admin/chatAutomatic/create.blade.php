...
@section('content')
    ...
    <div class="content container-fluid">
        <div class="card mb-3 mb-lg-5">
            ...
            <form class="js-step-form" action="{{route('chatautomatic.store')}}" method="post">
                @csrf
                <div class="card-body">
                    <div class="col-lg-12">
                        <!-- Form Group -->
                        <div class="row form-group">
                            <label for="chat" class="col-sm-3 col-form-label input-label">Chat <i
                                    ...
                                    data-placement="top"
                                    title="Isikan chat di sini"></i>
                            </label>
                            <div class="col-sm-12">
                                <textarea name="chat" class="ckeditor form-control @error('chat') is-invalid @enderror" id="chat">{{ old('chat') }}</textarea>
                                @error('chat')
